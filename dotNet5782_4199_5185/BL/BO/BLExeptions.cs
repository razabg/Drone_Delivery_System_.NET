...
namespace BO
{
    ...
    public class NotExistsException : Exception
    {
        ...
        public NotExistsException(int id, string message, Exception innerException) : base(message, innerException) => ID = ((DO.NotExistsException)innerException).ID;
    ...
    public class AlreadyExistsException : Exception
    {
        ...
        public AlreadyExistsException(int id, string message, Exception innerException) : base(message, innerException) => ID = ((DO.AlreadyExistsException)innerException).ID;
